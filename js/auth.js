define(['zepto', 'cookie', './config','core'], function($, zeCookie) {

    function auth() {

        W.openid = "22" //$.fn.cookie(mpappid + '_openid');
        W.expires_in = {
            expires: 7
        };
        ...
        Authorize.prototype.init = function(fn) {
                ...
                if (!openid) {
                    ...
                    if (!openid) {
                        ...
                        openid && zeCookie.cookie(mpappid + '_openid', openid, expires_in);
                        if (fn) {
                            setTimeout(function() {
                                fn();
                            }, 50);
                    ...
                    zeCookie.cookie(mpappid + '_openid', openid, expires_in);
                    if (fn) {
                        setTimeout(function() {
                            fn();
                        }, 50);
